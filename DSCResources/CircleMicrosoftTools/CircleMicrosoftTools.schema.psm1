Configuration CircleMicrosoftTools {
    ...
    cChocoPackageInstaller sqlserverexpress
    {
        ...
        Params    = "--IACCEPTSQLSERVERLICENSETERMS --ACTION install --INSTANCEID MSSQLSERVER --INSTANCENAME MSSQLSERVER --UPDATEENABLED FALSE --SECURITYMODE SQL --SAPWD r22rbf8*PUHjqzb3 --force --yes"
        DependsOn = "[CircleChoco]choco"
    }
